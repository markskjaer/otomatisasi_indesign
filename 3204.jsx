...
function Main() {
  ...
  var dictKec = {
    ...
    "3204300" : "Cilengkrang",
    "3204310" : "Cimenyan",
    "3204b1" : "Januari/"+"January",
    "3204b2" : "Februari/"+"February",
    "3204b3" : "Maret/"+"March",
    "3204b4" : "April/"+"April",
    "3204b5" : "Mei/"+"May",
    "3204b6" : "Juni/"+"June",
    "3204b7" : "Juli/"+"July",
    "3204b8" : "Agustus/"+"August",
    "3204b9" : "September/"+"September",
    "3204b10" : "Oktober/"+"October",
    "3204b11" : "November/"+"November",
    "3204b12" : "Desember/"+"December",
    "3204": "Bandung"
  };
            ...
            for (var m = 3; m < table.rows.length; m++) {
              ...
              if (csvData[csvIndex] && csvData[csvIndex][k] !== undefined) {
                ...
                if (j != 0) {
                  ...
                  textObj.justification = Justification.RIGHT_ALIGN;
                }
...
function changeRowColor(table, lastChangedRow) {
  ...
  const rowCount = lastRowCells.length; // Misalkan table adalah referensi ke elemen tabel Anda

    // Hanya menjalankan logika jika jumlah baris = 32
  if (rowCount === 32) {
      for (var n = 0; n < lastRowCells.length; n++) {
          lastRowCells[n].fillColor = "CustomColor";
          lastRowCells[n].fillTint = 100; // Mengatur tint warna
      }
   }
  //
}
